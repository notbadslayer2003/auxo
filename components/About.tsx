...
const TEAM = [
    {
        ...
        xp: '+10 ans',
        image: '/ludo.jpg', // 👉 renomme selon ton fichier réel
        ...
        <>
                ...
                <div className="container-auxo">
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            ...
                            <p className="reveal reveal-d2" style={{ fontFamily: 'var(--font-body)', fontSize: '0.975rem', color: 'rgba(18,27,31,0.65)', lineHeight: 1.75 }}>
                                Fondée à Mons par Ludo, l'agence accompagne des entrepreneurs et PME belges qui veulent prendre leur communication au sérieux — sans perdre de temps ni d'argent sur ce qui ne fonctionne pas.
                            </p>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                            ...
                            <div className="reveal reveal-d4" style={{ gridColumn: 'span 2', background: 'rgba(255,141,65,0.06)', border: '1px solid rgba(255,141,65,0.2)', borderRadius: '8px', padding: '28px 24px', display: 'flex', alignItems: 'center', gap: '20px' }}>
                                <img src="/Pathshort3.svg" alt="" aria-hidden="true" style={{ width: '64px', height: '64px', flexShrink: 0 }} />
            ...
            >
                ...
                <div style={{
                    ...
                    backgroundImage: "url('/Outlinelogo.svg')",
                ...
                <div className="container-auxo" style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <div style={{ maxWidth: '560px', marginBottom: 'clamp(48px,6vw,72px)' }}>
                        <span style={{ fontFamily: 'var(--font-display)', fontSize: '0.72rem', fontWeight: 600, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--color-vecteur)', display: 'block', marginBottom: '16px' }}>
                            L'équipe
                        </span>
                        <h2 className="text-display-lg" style={{ fontFamily: 'var(--font-display)', fontWeight: 700, color: 'var(--color-epure)', lineHeight: 1.1 }}>
                            ...
                            <span style={{ color: 'var(--color-vecteur)' }}>chaque projet.</span>
                        </h2>
                    </div>
                    ...
                    <style>{`
                        ...
                        .team-card:hover {
                            ...
                            border-color: rgba(255,141,65,0.4);
                        }
                        .team-card-img {
                            position: absolute;
                            inset: 0;
                        ...
                        .team-card:hover .team-card-gradient {
                            height: 100%;
                            background:
                                radial-gradient(circle at top right, rgba(255,141,65,0.35) 0%, transparent 60%),
                                linear-gradient(to top, rgba(18,27,31,0.97) 0%, rgba(18,27,31,0.72) 100%);
                        }
                        .team-card-front {
                            position: absolute;
                            bottom: 0; left: 0; right: 0;
                        ...
                        {TEAM.map((member) => (
                            <div key={member.name} className="team-card">
                                ...
                                <div className="team-card-front">
                                    ...
                                    <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.78rem', color: 'rgba(255,255,255,0.65)' }}>
                                        {member.role}
                                    </p>
                                </div>
                                ...
                                <div className="team-card-overlay" aria-hidden="true">
                                    ...
                                    <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.8rem', color: 'rgba(255,255,255,0.65)', marginBottom: '16px' }}>
                                        {member.role}
                                    </p>
                                    ...
                                    <span style={{
                                        ...
                                        background: 'rgba(255,141,65,0.1)', border: '1px solid rgba(255,141,65,0.25)',
