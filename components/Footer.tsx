    ...
    return (
        <footer style={{ background: '#f0ede8', borderTop: '1px solid rgba(18,27,31,0.1)' }}>
                ...
                <div className="container-auxo">
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '40px 48px' }}>
                        ...
                        <div style={{ minWidth: '180px' }}>
                            ...
                            <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.82rem', color: 'rgba(18,27,31,0.55)', lineHeight: 1.65, maxWidth: '200px', marginTop: '16px', marginBottom: '20px' }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.82rem', color: 'rgba(18,27,31,0.4)', marginTop: '4px' }}>
                                Mons, Belgique
                            </p>
                        </div>
            ...
            <div style={{ borderTop: '1px solid rgba(18,27,31,0.1)', padding: '18px 0' }}>
                <div className="container-auxo" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }}>
